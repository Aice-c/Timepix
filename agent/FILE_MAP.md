...
| `configs/experiments/b1_proton_c7_resnet18_tot_best_3seed.yaml` | B1-best Proton_C_7 3-seed verification | Fixes B1-2 best hyperparameters and varies only `training.seed=[42,43,44]` for mean/std reporting. |
...
| `configs/experiments/a7_final_gmu_main5feat_gated_3seed.yaml` | A7 final multimodal handcrafted confirmation | Three-seed verification of final `dual_stream_gmu_aux + CE one-hot` with A5 `main_5feat` gated handcrafted fusion; compares against A4c GMU without rerunning A7-0. |
