...
| `configs/experiments/a6a_alpha_tot_ordinal_loss_seed42.yaml` | A6a Alpha ordered-loss screening | Seed42 Alpha_100 ToT loss/label screening aligned with B3: Gaussian soft CE, CE+ExpectedMAE, and CE+angle-weighted EMD; CE one-hot is reused from A2-best and pure EMD is intentionally excluded. |
