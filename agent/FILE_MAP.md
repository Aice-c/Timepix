...
| `configs/experiments/a6b_alpha_tot_ce_emd_0p02_3seed.yaml` | A6b Alpha ordered-loss verification | Three-seed verification config for A6a validation-selected `CE+EMD lambda=0.02`; CE one-hot baseline is reused from A2-best and ExpectedMAE is intentionally not run. |
