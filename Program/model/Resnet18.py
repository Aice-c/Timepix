...
class CNN(nn.Module):
    def __init__(self):
        ...
        self.model = resnet18(pretrained=True)  # 加载预训练的ResNet18模型
        self.model.conv1 = nn.Conv2d(in_channels=config.input_channels(), out_channels=64, kernel_size=config.kernel_size, stride=1, padding=0, bias=False)
