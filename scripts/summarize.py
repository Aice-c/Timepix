...
def _row_from_metadata(metadata: dict, metadata_path: Path, root: Path, recursive: bool) -> dict:
    ...
    return {
        ...
        "label_type": data_info.get("label_type", dataset.get("label_type", "angle_folder")),
        "class_names": ";".join(data_info.get("class_names", [])) if isinstance(data_info.get("class_names"), list) else "",
        "modalities": "+".join(data_info.get("modalities", dataset.get("modalities", []))),
        ...
        "class_weight": loss.get("class_weight", loss.get("class_weights")),
        ...
        "val_weighted_f1": val.get("weighted_f1"),
